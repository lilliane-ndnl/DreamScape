  ...
  return (
    <div className={`pageContainer ${showBackground ? 'showBackground' : ''}`}>
      ...
      <h1 className="pageTitle">
        About <img src="/images/dreamscape-logo.png" alt="DreamScape" className={styles.titleLogo} />
      </h1>
      ...
      <div className="wideContainer">
        <div className="gradientCard" style={{ padding: '2.5rem', borderRadius: '20px', position: 'relative', zIndex: 1 }}>
          ...
          <h2 className={styles.whyTitle}>
            Why <img src="/images/dreamscape-logo.png" alt="DreamScape" className={styles.titleLogo} />?
          </h2>
          <p className={styles.aboutText}>
